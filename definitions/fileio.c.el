...
(et-declare
 (@def find-file-name-handler
       ...
       AnyFn?)
 (@def file-name-directory (filename: String) String?)
 (@def file-name-nondirectory (filename: String) String)
 (@def unhandled-file-name-directory (filename: String) String?)
 ...
 (@def make-temp-file-internal
       (prefix: String dir-flag: Any suffix: String text: String?)
       String)
 (@def make-temp-name (prefix: String) String)
 (@def file-name-concat
       (directory: String? &rest components: &List<String?>)
       String)
 (@def expand-file-name
       (name: String &optional default-directory: String?)
       String)
...
(et-declare
 ...
 (@def file-symlink-p (filename: String) String?)
...
(et-declare
 ...
 (@def set-file-selinux-context
       (filename: String
                  context: (&Tuple String? String? String? String?))
       Boolean)
 (@def file-acl (filename: String) String?)
...
(et-declare
 (@def insert-file-contents
       (filename: String &optional visit: Any beg: Integer? end: Integer? replace: Any)
       (Tuple String Integer))
 (@def write-region
       ([] start: [<= S String|IntOrMarker?]
        end: (switch S [IntOrMarker] [String? Nil])
        filename: String
        &optional append: Any visit: Any lockname: String?
        mustbenew: Any)
       Nil)
...
(et-declare
 ...
 (@def file-system-info
       (filename: String)
       (or Nil (Tuple Integer Integer Integer))))
