...
(et-declare
 ...
 (@def set-process-filter (process: Process filter: (or Nil True (fn (Args Process String))))
       (or Nil True (fn (Args Process String))))
 (@def process-filter (process: Process) (or Nil True (fn (Args Process String))))
 (@def set-process-sentinel (process: Process sentinel: (or Nil True (fn (Args Process String))))
       (or Nil True (fn (Args Process String))))
 (@def process-sentinel (process: Process) (or Nil True (fn (Args Process String))))
