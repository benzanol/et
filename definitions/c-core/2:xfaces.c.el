...
(et-declare
 ...
 ;; Cons chains).
 (@def x-family-fonts (&optional family: String? frame: Frame?) List<Vector<Todo>>)
 (@def x-list-fonts
...
(et-declare
 (@def color-distance
       ([R] color1: String|(Tuple Integer Integer Integer)
        color2: String|(Tuple Integer Integer Integer)
        &optional frame: Frame? metric: (fn (Args (Tuple Integer Integer Integer)
                                                 (Tuple Integer Integer Integer)) R)?)
       Integer|R))
