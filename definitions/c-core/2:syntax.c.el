...
(et-declare
 ...
 (@def internal-describe-syntax-value ([T] syntax: T) T))
...
(et-declare
 ...
 (@def parse-partial-sexp
       (from: IntOrMarker to: IntOrMarker
        ...
        oldstate: (Tuple Integer Integer? Integer? Nil|True|Integer Nil|True|Integer
                          Boolean Integer Nil|@syntax-table|Integer Integer?
                          List<Integer> Integer?)?
        commentstop: Any)
       (Tuple Integer Integer? Integer? Nil|True|Integer Nil|True|Integer
              Boolean Integer Nil|@syntax-table|Integer Integer?
              List<Integer> Integer?)))
