...
(et-declare
 ...
 (@def list ([T] &rest objects: T) (eval et-freshen-type-shallow T))
...
(et-declare
 ...
 (@def vector ([(= T Never)] &rest objects: &List<T>) VectorFresh<T>)
...
(et-declare
 (@def garbage-collect ()
       Nil|ListFresh<(or (Tuple Symbol Integer Integer)
...
(et-declare
 (@def memory-info () Nil|(Tuple Integer Integer Integer Integer))

 (@def memory-use-counts ()
       (Tuple Integer Integer Integer Integer Integer Integer Integer))
